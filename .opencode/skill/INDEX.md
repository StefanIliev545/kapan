...
Skills are loaded on-demand to provide specialized knowledge. Update this file when creating or removing skills.
...
Format: | `skill-name` | Load when <trigger conditions> |
-->
