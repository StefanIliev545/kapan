              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-base-200 rounded-xl transition-all hover:shadow-md">
                  <div className="relative w-10 h-10 rounded-full overflow-hidden bg-base-300 p-1 flex items-center justify-center">
                    <Image src="/logos/vesu.svg" alt="Vesu Protocol" fill className="object-contain p-1" />
                  </div>
                  <div>
                    <h4 className="font-medium text-base-content">Vesu</h4>
                    <p className="text-sm text-base-content/70">Starknet native lending protocol</p>
                  </div>
                </div>

                <div className="flex items-center gap-4 p-4 bg-base-200 rounded-xl transition-all hover:shadow-md">
                  <div className="relative w-10 h-10 rounded-full overflow-hidden bg-base-300 p-1 flex items-center justify-center">
                    <Image src="/logos/nostra.svg" alt="Nostra Protocol" fill className="object-contain p-1" />
                  </div>
                  <div>
                    <h4 className="font-medium text-base-content">Nostra</h4>
                    <p className="text-sm text-base-content/70">Starknet&apos;s money market</p>
                  </div>
                </div>
