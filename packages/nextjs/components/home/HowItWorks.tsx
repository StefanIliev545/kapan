import { CreditCardIcon, MagnifyingGlassIcon, ArrowRightIcon } from "@heroicons/react/24/outline";
        ...
        <div className="card-body p-6">
          <h2 className="text-3xl font-bold text-center mb-8 text-base-content">
            <div className="flex items-center justify-center gap-2">
              <ArrowRightIcon className="w-8 h-8 text-primary dark:text-accent" />
              How It Works
            </div>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card bg-base-200 dark:bg-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-lg">
              <div className="card-body items-center text-center gap-4">
                ...
                <div className="w-12 h-12 rounded-lg bg-primary/10 dark:bg-accent/10 flex items-center justify-center">
                  <CreditCardIcon className="w-6 h-6 text-primary dark:text-accent" />
                </div>
            ...
            <div className="card bg-base-200 dark:bg-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-lg">
              <div className="card-body items-center text-center gap-4">
                ...
                <div className="w-12 h-12 rounded-lg bg-primary/10 dark:bg-accent/10 flex items-center justify-center">
                  <MagnifyingGlassIcon className="w-6 h-6 text-primary dark:text-accent" />
                </div>
            ...
            <div className="card bg-base-200 dark:bg-base-300/30 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-lg">
              <div className="card-body items-center text-center gap-4">
                ...
                <div className="w-12 h-12 rounded-lg bg-primary/10 dark:bg-accent/10 flex items-center justify-center">
                  <ArrowRightIcon className="w-6 h-6 text-primary dark:text-accent" />
                </div>
