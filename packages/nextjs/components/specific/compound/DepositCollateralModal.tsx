          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center mb-1">
              <div className="flex items-center gap-2">
                ...
                {token.currentRate && (
                  <div className="badge badge-sm badge-neutral flex items-center gap-1">
                    ...
                    <span>{token.currentRate.toFixed(2)}% APY</span>
                  </div>
                )}
              </div>
              <div className="text-sm bg-base-200/60 py-1 px-3 rounded-lg flex items-center">
                ...
                <span className="font-medium ml-1">{formatDisplayNumber(formattedBalance)} {token.name}</span>
              </div>
            </div>
          ...
          <div className="p-5 bg-base-200 rounded-lg flex items-center min-h-[80px]">
            <div className="text-sm text-base-content/80">
              <p>
                ...
                {token.currentRate && (
                  <span> You&apos;ll earn {token.currentRate.toFixed(2)}% APY on your deposit.</span>
                )}
              </p>
            </div>
          </div>
