...
import { AccountInterface, Call, InvokeFunctionResponse, constants } from "starknet";
...
export const useTransactor = (_walletClient?: AccountInterface): UseTransactorReturn => {
  ...
  const writeTransaction = async (tx: Call[], withSendTransaction = true): Promise<string | undefined> => {
    resetStates();
    if (!walletClient) {
