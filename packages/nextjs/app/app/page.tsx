...
const AaveProtocolView = dynamic(
  ...
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Aave" protocolName="Aave" /> },
);
const CompoundProtocolView = dynamic(
  ...
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Compound" protocolName="Compound" /> },
);
const VenusProtocolView = dynamic(
  () => import("~~/components/specific/venus/VenusProtocolView").then(module => module.VenusProtocolView),
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Venus" protocolName="Venus" /> },
);
const VesuProtocolView = dynamic(
  () => import("~~/components/specific/vesu/VesuProtocolView").then(module => module.VesuProtocolView),
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Vesu" protocolName="Vesu" /> },
);
const NostraProtocolView = dynamic(
  ...
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Nostra" protocolName="Nostra" /> },
);
...
const AlchemixProtocolView = dynamic(
  ...
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading Alchemix" protocolName="Alchemix" /> },
);
const UniswapProtocolView = dynamic(
  ...
  {
    ssr: false,
    loading: () => <ProtocolSkeleton ariaLabel="Loading Uniswap" protocolName="Uniswap" variant="liquidity" />,
  },
);
const AerodromeProtocolView = dynamic(
  ...
  {
    ssr: false,
    loading: () => <ProtocolSkeleton ariaLabel="Loading Aerodrome" protocolName="Aerodrome" variant="liquidity" />,
  },
);
const WalletSection = dynamic(
  () => import("~~/components/specific/wallet/WalletSection").then(module => module.WalletSection),
  { ssr: false, loading: () => <ProtocolSkeleton ariaLabel="Loading wallet" protocolName="Wallet" variant="wallet" /> },
);
