...
const App: NextPage = () => {
  const { selectedNetworkId, selectedChainId } = useNetworkContext();
  const selectedNetwork = selectedNetworkId ?? "starknet";
  ...
  // Note: NetworkFilter already updates the context, so this is only for side effects
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const handleNetworkChange = (_id: string) => {
    // No state update needed here - NetworkFilter handles it via context
    // This callback is kept for potential future side effects (analytics, etc.)
  };
      ...
      <div className="flex-1 space-y-6">
        ...
        {mounted.has("arbitrum") && (
          <div className={selectedNetwork === "arbitrum" ? "space-y-4" : "space-y-4 hidden"} aria-hidden={selectedNetwork !== "arbitrum"}>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <AaveProtocolView chainId={selectedNetwork === "arbitrum" ? (selectedChainId ?? arbitrum.id) : arbitrum.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <CompoundProtocolView chainId={selectedNetwork === "arbitrum" ? (selectedChainId ?? arbitrum.id) : arbitrum.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <VenusProtocolView chainId={selectedNetwork === "arbitrum" ? (selectedChainId ?? arbitrum.id) : arbitrum.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
          </div>
        )}
        ...
        {mounted.has("base") && (
          <div className={selectedNetwork === "base" ? "space-y-4" : "space-y-4 hidden"} aria-hidden={selectedNetwork !== "base"}>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <AaveProtocolView chainId={selectedNetwork === "base" ? (selectedChainId ?? base.id) : base.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <CompoundProtocolView chainId={selectedNetwork === "base" ? (selectedChainId ?? base.id) : base.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <VenusProtocolView chainId={selectedNetwork === "base" ? (selectedChainId ?? base.id) : base.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
          </div>
        )}
        ...
        {mounted.has("optimism") && (
          <div className={selectedNetwork === "optimism" ? "space-y-4" : "space-y-4 hidden"} aria-hidden={selectedNetwork !== "optimism"}>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <AaveProtocolView chainId={selectedNetwork === "optimism" ? (selectedChainId ?? optimism.id) : optimism.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <CompoundProtocolView chainId={selectedNetwork === "optimism" ? (selectedChainId ?? optimism.id) : optimism.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
          </div>
        )}
        ...
        {mounted.has("linea") && (
          <div className={selectedNetwork === "linea" ? "space-y-4" : "space-y-4 hidden"} aria-hidden={selectedNetwork !== "linea"}>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <AaveProtocolView chainId={selectedNetwork === "linea" ? (selectedChainId ?? linea.id) : linea.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
            <StableArea as="section" minHeight="28rem" className="block" innerClassName="h-full">
              <CompoundProtocolView chainId={selectedNetwork === "linea" ? (selectedChainId ?? linea.id) : linea.id} enabledFeatures={{ swap: false, move: true }} />
            </StableArea>
          </div>
        )}
