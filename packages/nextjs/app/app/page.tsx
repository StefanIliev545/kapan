...
const DiscordIcon = () => (
  <div className="bg-indigo-600 p-1 rounded-full mr-2 flex items-center justify-center">
    <svg width="10" height="10" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg" className="brightness-150 invert">
