...
const contracts = {
  mainnet: {
    RouterGateway: {
      address:
        "0x7843eeef5a400a64d159cbffb5304fb8d412d2b290475e2961bd7bc3656037b",
      abi: [
        {
          type: "impl",
    ...
    VesuGateway: {
      address:
        "0x3b7d43d69ad78239677745347c673ff0d52bc3173496f4e1b2dba39b1ce6557",
      abi: [
        {
          type: "impl",
    ...
    VesuGatewayV2: {
      address:
        "0x21d05e2f5f7d5419085cb94585af6113ababf9f159dc00f3a3ffa55a39290c2",
      abi: [
        {
          type: "impl",
          name: "IVesuGatewayAdminImpl",
    ...
    AvnuGateway: {
      address:
        "0x3b2322bf67c71db11183276f8cfcf08a31587f9af35aff5465b731bb4a8964",
      abi: [
        {
          type: "impl",
    ...
    NostraGateway: {
      address:
        "0xc70388d28e515f3277fd61c8877b727f6c61cd8698abcbd98eb9f977f5e8b2",
      abi: [
        {
          type: "impl",
          name: "ILendingInstructionProcessorImpl",
    ...
    EkuboGateway: {
      address:
        "0x361f3c322c004666d7f0ab1edd797f580495f30261e487790cc3d4e6be59f42",
      abi: [
        {
          type: "impl",
          name: "ILendingInstructionProcessorImpl",
    ...
    OptimalInterestRateFinder: {
      address:
        "0x38f6c75bd2f556378045f31435ce54c6d2b06fd21e5c36550a3ac6787356f32",
      abi: [
        {
          type: "impl",
    ...
    UiHelper: {
      address:
        "0x3d844cd2a2b3ddb545412ef3e4eccc3d7163b87e38dc99e128e84cbc674d79d",
      abi: [
        {
          type: "impl",
          name: "ImplUIHelper",
