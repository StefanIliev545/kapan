...
const contracts = {
  ...
  mainnet: {
    RouterGateway: {
      address:
        "0x192a74456b3f296b44ecad8e70336350530af9641692f1f44da2ff914605726",
      abi: [
        {
          type: "impl",
          name: "RouterGatewayImpl",
    ...
    VesuGateway: {
      address:
        "0x6dc501275a7572c45548581ff9a275c2071708cc08992b25340f4208f9801f8",
      abi: [
        {
          type: "impl",
          name: "IVesuGatewayAdminImpl",
      ...
      classHash:
        "0x20c90b0c60d572365e49a11cc0efebd3653001ff4dd7b5accde11ea7d927e52",
    },
    AvnuGateway: {
      address:
        "0xc15fd36f34289a8f18c704c4e44ac13f1e62ade5665facad980a131cdd25fb",
      abi: [
        {
          type: "impl",
    ...
    NostraGateway: {
      address:
        "0x497b13007b92b42d7d69bc4f52ecf720a161c713e533f4530e18201467871df",
      abi: [
        {
          type: "impl",
          name: "ILendingInstructionProcessorImpl",
    ...
    EkuboGateway: {
      address:
        "0x16019a30292341b7c7fededfdae1e5eaa40f3fe6bb1ff250ff8f2372c2a6ce7",
      abi: [
        {
          type: "impl",
          name: "ILendingInstructionProcessorImpl",
    ...
    OptimalInterestRateFinder: {
      address:
        "0x71f99c8ab3ab47734bd9774611b4cbdb3f7f65a5d0f0a1858b9be3f04aeefe0",
      abi: [
        {
          type: "impl",
          name: "IOptimalInterestRateFinderImpl",
    ...
    UiHelper: {
      address:
        "0x19a95c29f8ed4cc838882b692f780d23fac2f5ed809a143988f4ecd7fcdf6d",
      abi: [
        {
          type: "impl",
          name: "ImplUIHelper",
  ...
  sepolia: {
    RouterGateway: {
      address:
        "0x79343c82b99640aba6264df481bf79cfde07f920c4b1169b0666130925ec68f",
      abi: [
        {
          type: "impl",
          name: "RouterGatewayImpl",
    ...
    VesuGateway: {
      address:
        "0x1891273f09367ca65e3545ecd4018eeb23c6de36ca86bd57c386f88be624e7e",
      abi: [
        {
          type: "impl",
          name: "IVesuGatewayAdminImpl",
      ...
      classHash:
        "0x2826702e4e7e7690771b2c02d9643d2c7a7bf4456ec58be6fdc392a1157a8ef",
    },
    NostraGateway: {
      address:
        "0x291acf6d609aa1e2675ecfa1ef8379cc14b4cffcab5d1fe52dcf276e1de933",
      abi: [
        {
          type: "impl",
          name: "ILendingInstructionProcessorImpl",
    ...
    OptimalInterestRateFinder: {
      address:
        "0x2061b5b7d12a9e0bff68e4ac32103f4c92cef6bbd58251c252c1a125ad74477",
      abi: [
        {
          type: "impl",
          name: "IOptimalInterestRateFinderImpl",
    ...
    UiHelper: {
      address:
        "0x62e3d710d6de926c550bfbb5cfd3a4df6de8eefa795deaff32ca6131970b020",
      abi: [
        {
          type: "impl",
          name: "ImplUIHelper",
