...
import { KyberSwapAdapter } from "./KyberSwapAdapter.sol";
...
contract KyberSwapGateway is IGateway, ProtocolGateway, Ownable, ReentrancyGuard {
    ...
    function setAdapter(address _adapter) external onlyOwner {
        adapter = KyberSwapAdapter(_adapter);
    }
